...
public class P08FuelTankPart2Version1 {
    public static void main(String[] args) {
        ...
        //всичко зависи от вида гориво, затова видовете гориво ще са главните условия;
        //наличието на членска карта (съответно ако има чл. карта, ще има отстъпка от цената; ако няма чл. карта, няма отстъпка от цената) ще е подусловие на всяко от условията
        switch (typeOfFuel) {
            case "Gas":
