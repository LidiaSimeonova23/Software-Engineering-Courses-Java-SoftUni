...
public class P05LoginVersion3 {
    public static void main(String[] args) {
        ...
        while (!input.equals(correctPassword)) {              //докато входните данни са различно от вярната парола, ще четем нови входни данни и ще проверяваме колко е броят на неуспешните опити
            ...
            input = scanner.nextLine();   //update - подканяме скенера да прочете следващия ред от входни данни (ако не го направим, ще стане безкраен цикъл)
        }
        ...
        } else {        //else if (numberOfIncorrectPasswords == 4)
