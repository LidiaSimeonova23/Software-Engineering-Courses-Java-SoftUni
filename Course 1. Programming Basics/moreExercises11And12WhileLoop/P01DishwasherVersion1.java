...
public class P01DishwasherVersion1 {
    public static void main(String[] args) {
        ...
        int differenceInQuantityOfDetergent = Math.abs(availableQuantityOfDetergent - usedQuantityOfDetergent);
        if (availableQuantityOfDetergent >= usedQuantityOfDetergent) {            //В случай че количеството препарат е било достатъчно за измиването на съдовете
            ...
            System.out.printf("Leftover detergent %d ml.", differenceInQuantityOfDetergent);
        } else {        //В противен случай (ако количеството препарат не е било достатъчно за измиването на съдовете)
            System.out.printf("Not enough detergent, %d ml. more necessary!", differenceInQuantityOfDetergent);
        }
