...
public class P06VetParkingVersion2 {
    public static void main(String[] args) {
        ...
        for (int currentDay = 1; currentDay <= numberOfDays; currentDay++) {
            ...
            for (int currentHour = 1; currentHour <= numberOfHoursPerEachDay; currentHour++) {
                ...
                if (currentDay % 2 == 1 && currentHour % 2 == 0) {           //ако денят е нечетен и в същото време часът е четен
                    feePerHour = 1.25;
                } else if (currentDay % 2 == 0 && currentHour % 2 == 1) {     //ако денят е четен и в същото време часът е нечетен
                    feePerHour = 2.50;
