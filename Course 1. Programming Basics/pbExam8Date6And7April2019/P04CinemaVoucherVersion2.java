...
public class P04CinemaVoucherVersion2 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        //Първоначално се чете един ред:
        double valueOfVoucher = Integer.parseInt(scanner.nextLine());    //Стойността на ваучера (първоначална налична сума) – може да е дробно, може да е и цяло число в интервала [1…100000]
        ...
        while (!input.equals("End")) {
            ...
            double priceOfCurrentPurchase = 0;      //създаваме си променлива за цената на текущата дума
            if (currentChosenPurchase.length() > 8) {        //Ако името на покупката съдържа повече от 8 символа, то тя е билет за филм, а нейната цена представлява сумата на ASCII символите от първите ѝ два символа.
                ...
                if (valueOfVoucher < priceOfCurrentPurchase) {
                    ...
                    break;        //прекъсваме само цикъла (и следва да се извърши проверката извън цикъла)
                }
        ...
        //ако входните данни са станали "End", се принтират следните два реда:
        if (input.equals("End")) {
            System.out.printf("%d%n", numberOfBoughtTickets);
            System.out.printf("%d", numberOfBoughtOtherPurchases);
        }
