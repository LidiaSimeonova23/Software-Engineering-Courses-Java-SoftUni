...
public class P06StrongNumberVersion3 {
    public static void main(String[] args) {
        ...
        if (sumFactorials == Integer.parseInt(numberAsText)) {     //- превръщаме текста в число и го сравняваме с число        //if ((sumFactorials + "") == numberAsText)   - превръщаме числото в текст и го сравняваме с текст
