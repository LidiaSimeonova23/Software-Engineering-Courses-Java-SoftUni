...
public class P03AluminumJoineryVersion2 {
    public static void main(String[] args) {
        ...
        if (typeOfJoineries.equals("90X130")) {
            unitPriceOf1Joinery = 110;

            if (numberOfJoineries > 60) {         // Над 60 броя – 8% отстъпка от цената
                unitPriceOf1Joinery = unitPriceOf1Joinery - (unitPriceOf1Joinery * 8 / 100);
            } else if (numberOfJoineries > 30) {      // Над 30 броя – 5% отстъпка от цената
                unitPriceOf1Joinery = unitPriceOf1Joinery - (unitPriceOf1Joinery * 5 / 100);
            }

        } else if (typeOfJoineries.equals("100X150")) {
            unitPriceOf1Joinery = 140;

            if ((numberOfJoineries > 80)) {        // Над 80 броя – 10% отстъпка от цената
                unitPriceOf1Joinery = unitPriceOf1Joinery - (unitPriceOf1Joinery * 10 / 100);
            } else if (numberOfJoineries > 40) {        // Над 40 броя – 6% отстъпка от цената
                unitPriceOf1Joinery = unitPriceOf1Joinery - (unitPriceOf1Joinery * 6 / 100);
            }

        } else if (typeOfJoineries.equals("130X180")) {
            unitPriceOf1Joinery = 190;

            if ((numberOfJoineries > 50)) {        // Над 50 броя – 12% отстъпка от цената
                unitPriceOf1Joinery = unitPriceOf1Joinery - (unitPriceOf1Joinery * 12 / 100);
            } else if (numberOfJoineries > 20) {        // Над 20 броя – 7% отстъпка от цената
                unitPriceOf1Joinery = unitPriceOf1Joinery - (unitPriceOf1Joinery * 7 / 100);
            }

        } else if (typeOfJoineries.equals("200X300")) {
            unitPriceOf1Joinery = 250;

            if ((numberOfJoineries > 50)) {        // Над 50 броя – 14% отстъпка от цената
                unitPriceOf1Joinery = unitPriceOf1Joinery - (unitPriceOf1Joinery * 14 / 100);
            } else if (numberOfJoineries > 25) {        // Над 25 броя – 9% отстъпка от цената
        ...
        } else if (shipmentMethod.equals("Without delivery")) {
