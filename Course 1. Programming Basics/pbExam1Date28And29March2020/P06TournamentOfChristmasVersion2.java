...
public class P06TournamentOfChristmasVersion2 {
    public static void main(String[] args) {
        ...
        // във вътрешния (while цикъл, защото не знаем колко ще са итерациите) ще итерираме по всички спортове за текущия ден (и съответно дали имаме победа, или загуба)
        ...
        for (int currentDay = 1; currentDay <= numberOfDays; currentDay++) {
            ...
            while (!input.equals("Finish")) {
                ...
                if (result.equals("win")) {        //в случай че сме спечелили играта
                ...
                } else if (result.equals("lose")) {       //в случай че сме загубили играта
