...
public class P02ReportSystemVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("End")) {
            ...
            //Ако продуктът надвишава 100 лв., за него не може да се плати в брой. Или ако продуктът е на цена под 10 лв., за него не може да се плати с кредитна карта
            if ((priceOfCurrentStuff > 100 && typeOfPayment.equals("cash")) || (priceOfCurrentStuff < 10 && typeOfPayment.equals("credit card"))) {
