...
public class P04TouristShopVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("Stop")) {
            ...
            if (availableBudget >= priceOfCurrentProduct) {        //ако имаме достатъчно пари, си купуваме текущия продукт  -> броят на купените продукти се увеличава с единица и общата сума на всички купени продукти нараства
                ...
                System.out.printf("You need %.2f leva!", priceOfCurrentProduct - availableBudget);
                break;      //прекъсваме само цикъла (и се изпълнява проверката под цикъла)
            }
        ...
        //ако някога входните данни са станали "Stop"
