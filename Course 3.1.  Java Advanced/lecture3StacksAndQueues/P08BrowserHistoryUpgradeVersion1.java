...
public class P08BrowserHistoryUpgradeVersion1 {
    public static void main(String[] args) {
        ...
        while (!input.equals("Home")) {
            ...
            if (input.equals("back")) {
                if (backwardHistoryStack.isEmpty() || backwardHistoryStack.size() == 1) {      //условието, когато не можем да се върнем назад     //if (backwardHistoryStack.size() <= 1)
                    System.out.println("no previous URLs");
                } else {       //в противен случай можем да се върнем назад
                ...
                } else {          //в противен случай не можем да преминем напред
