...
public class P07VendingMachineVersion4 {
    public static void main(String[] args) {
        ...
        while (!input.equals("Start")) {      //докато входните данни са различни от "Start", ще четем монети (тоест, ще пускаме монети във вендинг машината)
            ...
            if (currentCoin != 0.1 && currentCoin != 0.2 && currentCoin != 0.5 && currentCoin != 1 && currentCoin != 2) {            //ако монетите, които се пускат, са различни от дадените, машината няма да ги приеме
        ...
        while (!input.equals("End")) {           //докато входните данни са различни от "End", ще четем име на продукт
            ...
            if (input.equals("Nuts")) {
                unitPrice = 2.0;
                if (sumOfInsertedCoins >= 2.0) {                    //ако е вкарал в машината достатъчно пари, ще си купи ядки  (тоест, ако е вкарал поне толкова пари, колкото са ядките)
                    System.out.printf("Purchased %s%n", input);
                    sumOfInsertedCoins -= 2.0;       // sumOfInsertedCoins = sumOfInsertedCoins - 2.0;            //вкараната в машината сума става домоментната сума минус цената на ядките
                } else {
                    System.out.println("Sorry, not enough money");
                }
            } else if (input.equals("Water")) {
                unitPrice = 0.7;
                if (sumOfInsertedCoins >= 0.7) {                    //ако е вкарал в машината достатъчно пари, ще си купи вода  (тоест, ако е вкарал поне толкова пари, колкото е водата)
                    System.out.printf("Purchased %s%n", input);
                ...
                unitPrice = 1.5;
                if (sumOfInsertedCoins >= 1.5) {                    //ако е вкарал в машината достатъчно пари, ще си купи чипс  (тоест, ако е вкарал поне толкова пари, колкото е чипсът)
                    System.out.printf("Purchased %s%n", input);
                ...
                unitPrice = 0.8;
                if (sumOfInsertedCoins >= 0.8) {                    //ако е вкарал в машината достатъчно пари, ще си купи сода  (тоест, ако е вкарал поне толкова пари, колкото е содата)
                    System.out.printf("Purchased %s%n", input);
                ...
                unitPrice = 1.0;
                if (sumOfInsertedCoins >= 1.0) {                  //ако е вкарал в машината достатъчно пари, ще си купи кола  (тоест, ако е вкарал поне толкова пари, колкото е колата)
                    System.out.printf("Purchased %s%n", input);
            ...
            } else {      //във всички останали случаи (тоест, ако продуктът не е никой от изброените)
