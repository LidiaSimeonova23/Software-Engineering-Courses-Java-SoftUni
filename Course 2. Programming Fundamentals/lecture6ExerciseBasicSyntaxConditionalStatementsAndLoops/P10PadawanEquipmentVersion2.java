...
public class P10PadawanEquipmentVersion2 {
    public static void main(String[] args) {
        ...
        double numberOfSabers = Math.ceil(numberOfStudents + (numberOfStudents * 10 * 0.01));         //намираме колко меча трябва да се купят
