...
public class P04CinemaVoucherVersion3 {
    public static void main(String[] args) {
        ...
        while (!input.equals("End")) {
            ...
            if (currentChosenPurchase.length() > 8) {        //Ако името на покупката съдържа повече от 8 символа, то тя е билет за филм, а нейната цена представлява сумата на ASCII символите от първите ѝ два символа.
                ...
                if (valueOfVoucher >= priceOfCurrentPurchase) {       //ако има пари, купуваме билет за филм
                ...
                } else {         //else if (valueOfVoucher < priceOfCurrentPurchase)      //ако няма пари, не купуваме билета, а просто принтираме купеното до момента
                ...
                //второ условие за приключване на програмата -> при покупка, чиято стойност е по-голяма от останалите пари от ваучера
                if (valueOfVoucher >= priceOfCurrentPurchase) {        //ако има пари, купуваме стоката
