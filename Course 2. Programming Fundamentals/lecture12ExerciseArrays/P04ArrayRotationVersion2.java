...
public class P04ArrayRotationVersion2 {
    public static void main(String[] args) {
        ...
        int[] numbersAsTextsArray = Arrays.stream(scanner.nextLine().split(" ")).mapToInt(Integer::parseInt).toArray();      //от първия ред на конзолата четем масив от цели числа
        ...
        for (int currentRotation = 1; currentRotation <= numberOfRotations; currentRotation++) {    //с този for цикъл броим завъртанията (взимаме текущата ротация) - затова условието е от 1 до n /numberOfRotations/ включително
            ...
            int oldValueOfFirstElement = numbersAsTextsArray[0];       //създаваме си променливата oldValueOfFirstElement, в която да запазим/съхраним старата/началната стойност на първия елемент в масива ->
            ...
            for (int index = 0; index <= numbersAsTextsArray.length - 2; index++) {     //от първия елемент до предпоследния елемент
                //условието във for цикъла може да е и така:  for (int index = 0; index < numbersAsTextsArray.length - 1; index++)
                numbersAsTextsArray[index] = numbersAsTextsArray[index + 1];    //на всяка итерация на вложения for цикъл на текущия елемент от масива присвояваме като стойност следващия елемент от масива (така реално изместваме елементите в масива с един индекс по-напред /по-наляво/)
            }
        ...
        //принтирането на масив (на елементите му) става чрез foreach цикъл (или чрез for цикъл):
        //вариант 1 - с foreach цикъл:
        for (int element : numbersAsTextsArray) {
            System.out.print(element + " ");      //всички елементи на масива да са на един ред с интервал между тях
            //System.out.printf("%d ", element);
        }

        //вариант 2 - с for цикъл:
        /*for (int index = 0; index <= numbersAsTextsArray.length - 1; index++) {       //for (int index = 0; index < numbersAsTextsArray.length; index++)
            System.out.print(numbersAsTextsArray[index] + " ");     //всички елементи на масива да са на един ред с интервал между тях
            //System.out.printf("%d ", numbersAsTextsArray[index]);
        }*/
