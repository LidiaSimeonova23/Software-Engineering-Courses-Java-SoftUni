...
public class P03WorldSnookerChampionshipVersion2 {
    public static void main(String[] args) {
        ...
        //като основни случаи разглеждаме етапа от турнира
        if (championshipStage.equals("Quarter final")) {                     //в случай че етапът е четвъртфинал
        ...
        } else if (championshipStage.equals("Semi final")) {                         //или в случай че етапът е полуфинал
            if (ticketType.equals("Standard")) {             //ако билетът е стандартен
                ticketPrice = 75.88;
            } else if (ticketType.equals("Premium")) {       //или ако билетът е премиум
                ticketPrice = 125.22;
        ...
        } else if (championshipStage.equals("Final")) {                             //или в случай че етапът е финал
            if (ticketType.equals("Standard")) {           //ако билетът е стандартен
                ticketPrice = 110.10;
            } else if (ticketType.equals("Premium")) {     //или ако билетът е премиум
                ticketPrice = 160.66;
