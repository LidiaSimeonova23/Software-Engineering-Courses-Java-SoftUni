...
public class P03VacationVersion2 {
    public static void main(String[] args) {
        ...
        //•	Students – if the group is bigger than or equal to 30 people, you should reduce the total price by 15%  -> total price is 85% from total price
        ...
        //•	Regular – if the group is bigger than or equal to 10 and less than or equal to 20, reduce the total price by 5%  -> total price is 95% from total price
        if (typeOfGroup.equals("Regular") && (numberOfPeople >= 10 && numberOfPeople <= 20)) {
            totalPrice = totalPrice * 95 * 0.01;
        }
