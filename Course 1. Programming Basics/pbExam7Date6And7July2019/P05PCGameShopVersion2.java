...
public class P05PCGameShopVersion2 {
    public static void main(String[] args) {
        ...
        for (int currentGame = 1; currentGame <= numberOfSoldGames; currentGame++) {
            ...
            if (nameOfCurrentGame.equals("Hearthstone")) {            //ако играта е Hearthstone, броят на тези игри се увеличава с единица
                numberOfHearthstoneGames++;    //numberOfHearthstoneGames = numberOfHearthstoneGames + 1;    //numberOfHearthstoneGames += 1;
            } else if (nameOfCurrentGame.equals("Fornite")) {          //или ако играта е Fornite, броят на тези игри се увеличава с единица
                numberOfForniteGames++;
            } else if (nameOfCurrentGame.equals("Overwatch")) {        //или ако играта е Overwatch, броят на тези игри се увеличава с единица
                numberOfOverwatchGames++;
            } else {        //във всички останали случаи броят на другите игри (които са различни от Hearthstone/Fornite/Overwatch)  се увеличава с единица
                numberOfOthersGames++;
            }
