...
public class P02SafariVersion1 {
    public static void main(String[] args) {
        ...
        double differenceInSum = Math.abs(availableBudget - necessarySum);
        if (availableBudget >= necessarySum) {
            System.out.printf("Safari time! Money left: %.2f lv.", differenceInSum);      //availableBudget - necessarySum
        } else {
            System.out.printf("Not enough money! Money needed: %.2f lv.", differenceInSum);    //necessarySum - availableBudget
        }
