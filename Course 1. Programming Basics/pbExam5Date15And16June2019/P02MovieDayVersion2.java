...
public class P02MovieDayVersion2 {
    public static void main(String[] args) {
        ...
        if (theWholeNecessaryTime <= availableTime) {       //Ако времето за заснемане на филма ви стигне
            System.out.printf("You managed to finish the movie on time! You have %.0f minutes left!", availableTime - theWholeNecessaryTime);
        } else {         //else if (theWholeNecessaryTime > availableTime)         //Ако времето НЕ ВИ стигне
            System.out.printf("Time is up! To complete the movie you need %.0f minutes.", theWholeNecessaryTime - availableTime);
        }
