...
public class P11SnowballsVersion2 {
    public static void main(String[] args) {
        ...
        int snowballQualityHighest = 0;   //създаваме си променлива за снежната топка с най-високо качество
        ...
        for (int currentSnowball = 1; currentSnowball <= numberOfSnowballs; currentSnowball++) {         //for (int i = 1; i <= numberOfSnowballs; i++)
            ...
            if (currentSnowballValue > maxValue) {
                ...
                snowballQualityHighest = currentSnowballQuality;
            }
        ...
        System.out.printf("%d : %d = %.0f (%d)", snowballSnowBiggest, snowballTTimeBiggest, maxValue, snowballQualityHighest);
    }
}
