...
public class P07ShoppingVersion2 {
    public static void main(String[] args) {
        ...
        if (budget >= sumOfAllGoods) {              //•	Ако бюджетът е достатъчен:
            System.out.printf("You have %.2f leva left!", budget - sumOfAllGoods);
        } else {
            System.out.printf("Not enough money! You need %.2f leva more!", sumOfAllGoods - budget);
        }
