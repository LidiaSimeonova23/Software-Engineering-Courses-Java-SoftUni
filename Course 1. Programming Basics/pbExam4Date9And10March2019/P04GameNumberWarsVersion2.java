...
public class P04GameNumberWarsVersion2 {
    public static void main(String[] args) {
        ...
        boolean numberWarsHasHappened = false;
        ...
        while (!input.equals("End of game")) {
            ...
            if (cardOfFirstPlayer > cardOfSecondPlayer) {       //Ако картата на първия играч е с по-голяма стойност от картата на втория играч, първият получава точки, които са равни на разликата между картата на първия и картата на втория
                ...
                return;         //прекъсваме (приключваме) цялата програма
            }
        ...
        //щом програмата не е била прекъсната (заради еднакви карти), значи сме достигнали до команда "End of game", няма победител, просто си принтираме точките на всеки от играчите:
