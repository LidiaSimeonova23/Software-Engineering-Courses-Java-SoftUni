...
public class P01PipesInPoolVersion2 {
    public static void main(String[] args) {
        ...
        if (realLitresOfWaterInPool > capacityOfPoolInLitres) {
            System.out.printf("For %.2f hours the pool overflows with %.2f liters.", timeWhenWorkerIsAbsent, realLitresOfWaterInPool - capacityOfPoolInLitres);
