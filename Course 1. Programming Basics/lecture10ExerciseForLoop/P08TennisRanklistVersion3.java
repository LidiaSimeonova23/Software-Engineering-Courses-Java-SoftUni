...
public class P08TennisRanklistVersion3 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= numberOfTournaments; i++) {              //цикълът ще се завърти толкова пъти, колкото е броят на турнирите
            ...
            if (stageOfTournament.equals("W")) {                        //W - ако е победител, получава 2000 точки
            ...
            } else if (stageOfTournament.equals("F")) {                        //F - ако е финалист, получава 1200 точки
                points = points + 1200;
            ...
            } else if (stageOfTournament.equals("SF")) {                       //SF - ако е полуфиналист, получава 720 точки
                points = points + 720;
