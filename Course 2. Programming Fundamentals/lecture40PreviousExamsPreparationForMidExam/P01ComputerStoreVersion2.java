...
public class P01ComputerStoreVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("special") && !input.equals("regular")) {
            ...
            if (priceOfCurrentPartWithoutTax <= 0) {          //Ако прочетената цена не е положително число, да се принтира "Invalid price!" и да се прочете следващата цена.
                System.out.println("Invalid price!");
            } else {       //else if (priceOfCurrentPartWithoutTax > 0)   //ако прочетената цена е положително число (валидна цена)
        ...
        boolean isSpecialClient = input.equals("special");    //създаваме си допълнителна булева променлива, която ни държи истината (клиентът е специален, когато входните данни са съвпаднали със "special"

        if (isSpecialClient) {     //ако "клиентът е специален" е истина
