...
public class PMoreExercises05MessagesVersion1 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            switch (currentNumber) {      //проверяваме кое е числото и принтираме съответния текст (някоя буква или space/интервал)
                case 2:
                    System.out.print("a");
                    break;
                case 22:
