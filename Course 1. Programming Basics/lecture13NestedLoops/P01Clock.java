...
public class P01Clock {
    public static void main(String[] args) {
        ...
        //за конкретния час (от 0 до 23) искаме да принтираме всичките му минути (от 0 до 59)
        ...
        for (int hour = 0; hour <= 23; hour++) {
            for (int min = 0; min <= 59; min++) {
                System.out.printf("%d:%d%n", hour, min);                //дори и минутите да са от 0 до 9, няма да ги принтираме с водеща 0 отпред
            }
        }
