...
public class P07CondenseArrayToNumberVersion4 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        //ТОВА РЕШЕНИЕ Е ВЯРНО (получих 100 точки), но не е много логично (правя въображаема промяна на дължината на масива, реално дължината си е такава, каквато е в началото, просто принтирам само първия елемент)
        ...
        if (numbersArray.length == 1) {    //ако дължината на прочетения масив е равна на 1 (тоест, ако масивът се състои само от един елемент)
            ...
            while (lengthOfArray > 1) {       //докато дължината на масива е повече от 1 (тоест, докато в масива има повече от 1 елемент), ще събираме два съседни елемента
                ...
                for (int index = 0; index <= lengthOfArray - 2; index++) {   //for (int index = 0; index < lengthOfArray - 1; index++)    //както вече по-горе обясних, ще обходим елементите на масива - от първия до предпоследния елемент (а не до последния) в масива
                    //на всяка итерация на for цикъла ще взимаме два съседни елемента (текущия и следващия):
                ...
                lengthOfArray = lengthOfArray - 1;     //update на условието в while цикъла    //намаляваме дължината на масива (премахваме от него последния елемент) - нещо, което по принцип не е възможно да направим
            ...
            System.out.println(sumOfCurrentAndNextElementOfArray);    //принтираме единствения елемент на въображаемия ни сгъстен масив, който получихме (това реално е последната намерена сума от два съседни елемента)
            //вдействителност масивът не е сгъстен, той си е с дължината, с която си беше и в началото, просто променихме стойностите на елементите му и накрая принтирахме само първия елемент от масива
