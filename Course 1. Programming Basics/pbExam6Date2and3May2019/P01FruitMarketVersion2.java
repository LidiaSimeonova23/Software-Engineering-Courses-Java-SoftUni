...
public class P01FruitMarketVersion2 {
    public static void main(String[] args) {
        ...
        //цената на малините е наполовина по-ниска от тази на ягодите -> значи, че цената на портокалите е 60% от цената на малините
        double raspberriesPricePer1Kg = strawberriesPricePer1Kg / 2;

        //цената на портокалите е с 40% по-ниска от цената на малините -> значи, че цената на портокалите е 60% от цената на малините
        double orangesPricePer1Kg = raspberriesPricePer1Kg * 60 * 0.01;

        //цената на бананите е с 80% по-ниска от цената на малините -> значи, че цената на бананите е 20% от цената на малините
        double bananasPricePer1Kg = raspberriesPricePer1Kg * 20 * 0.01;
