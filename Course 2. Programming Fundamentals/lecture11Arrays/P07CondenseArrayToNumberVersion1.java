    ...
    public static void main(String[] args) {
        ...
        for (int index = 0; index < numbersArray.length; index++) {     //for (int index = 0; index <= numbersArray.length - 1; index++)
            ...
            if (index == numbersArray.length - 1) {    //ако текущият индекс е последният индекс в масива numbersArray (ако елементът, който се намира на текущия index, е последният елемент от масива numbersArray)
                ...
                condensedArray = condensedSecondArray;      //на първия създаден сгъстен масив (а именно condensedArray) присвояваме като стойност втория създаден сгъстен масив (а именно condensedSecondArray)  - така реално намаляваме дължината на масив condensedArray (като същевременно с това променяме стойностите на елементите му)
