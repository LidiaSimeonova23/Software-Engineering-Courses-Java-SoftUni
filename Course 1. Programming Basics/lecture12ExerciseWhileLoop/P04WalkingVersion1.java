...
public class P04WalkingVersion1 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        int totalSteps = 0;        //създаваме си променлива за всички извървени стъпки - с начална стойност 0
        boolean goingHome = false;           //създаваме си булева променлива - за да се върти цикълът, даваме първоначална стойност false  (тоест, Джеси ще продължи да се опитвада достигне 10000 крачки)
        ...
        while (totalSteps < 10000) {
            ...
            if (input.equals("Going home")) {                  //ако въведе Going home, вървейки към вкъщи, извървява стъпки - трябва да прочетем колко стъпки ще извърви и да ги добавим към извървените до момента
                goingHome = true;               //goingHome става истина
        ...
        if (goingHome && totalSteps < 10000) {               //ако се е прибрала и ако извървените стъпки са под 10000
            System.out.printf("%d more steps to reach goal.", 10000 - totalSteps);
        } else {                                             //в противен случай (тоест, когато е извървяла 10000 крачки)
