...
public class P03EasterTripVersion2 {
    public static void main(String[] args) {
        ...
        if (destination.equals("France")) {                                       //ако дестинацията е Франция
        ...
        } else if (destination.equals("Italy")) {                                          //или ако дестинацията е Италия
            if (reservedDays.equals("21-23")) {                     //ако датите са 21-23
                priceForOneNight = 28;
            } else if (reservedDays.equals("24-27")) {              //или ако датите са 24-27
                priceForOneNight = 32;
        ...
        } else if (destination.equals("Germany")) {                                          //или ако дестинацията е Германия
