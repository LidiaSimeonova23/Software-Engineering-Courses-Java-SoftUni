...
public class P05MovieRatings {
    public static void main(String[] args) {
        ...
        String filmWithTheHighestRating = "";         //създаваме си променлива за филма с най-висок рейтинг - в началото не знаем кой е (променливата е от тип String и е с дефолтна стойност празен String)
        double minRating = Double.MAX_VALUE;       //създаваме си променлива за най-нисък рейтинг
        String filmWithTheLowestRating = "";          //създаваме си променлива за филма с най-нисък рейтинг - в началото не знаем кой е (променливата е от тип String и е с дефолтна стойност празен String)
