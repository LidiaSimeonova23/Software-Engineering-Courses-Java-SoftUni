...
public class P04RenovationVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("Tired!")) {
            ...
            if (currentLitresOfPaint <= areaThatHasToBePainted) {
                areaThatHasToBePainted -= currentLitresOfPaint;        //areaThatHasToBePainted = areaThatHasToBePainted - currentLitresOfPaint;     //площта за боядисване намалява
                if (areaThatHasToBePainted == 0) {      //проверка - ако не е останала площ за боядисване
                    System.out.println("All walls are painted! Great job, Pesho!");
                    break;    //прекъсваме само цикъла
                }
        ...
        //ако все някога се е стигнало до прочитане на входни данни "Tired!"
