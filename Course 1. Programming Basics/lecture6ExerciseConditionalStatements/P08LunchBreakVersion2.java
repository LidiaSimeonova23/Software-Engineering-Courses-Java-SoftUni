...
public class P08LunchBreakVersion2 {
    public static void main(String[] args) {
        ...
        double neededTimeForAllActivities = durationOfEpisode + timeToEat + timeToRelax;

        double differenceInTime = Math.abs(durationOfLunchBreak - neededTimeForAllActivities);
        differenceInTime = Math.ceil(differenceInTime);
        if (durationOfLunchBreak >= neededTimeForAllActivities) {
