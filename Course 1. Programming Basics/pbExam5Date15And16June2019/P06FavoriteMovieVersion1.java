...
public class P06FavoriteMovieVersion1 {
    public static void main(String[] args) {
        ...
        while (!input.equals("STOP")) {
            ...
            if (numberOfFilms == 7) {
                ...
                return;         //прекъсваме цялата програма (и няма да се изпълни нищо друго - нито в цикъла, нито извън него)
            }
        ...
        //щом компилаторът не е срещнал оператор return, значи все някога се е стигнало до прочитане на входни данни "STOP", и принтираме:
        System.out.printf("The best movie for you is %s with %d ASCII sum.", bestFilm, maxSum);
    }
}