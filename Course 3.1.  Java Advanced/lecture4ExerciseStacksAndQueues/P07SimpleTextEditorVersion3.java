...
public class P07SimpleTextEditorVersion3 {
    public static void main(String[] args) {
        ...
        for (int count = 1; count <= n; count++) {
            ...
            } else if (command.equals("2")) {     //command = "2"
                //преди модификация съхраняваме текущото състояние на текста преди промяната
            ...
            } else if (command.equals("3")) {      //command = "3"
                int position = Integer.parseInt(commandPartsArray[1]);          //позиция на буквата в думата
                char symbol = currentText.charAt(position - 1);      //position - 1 e индексът на буквата      //пример: първият елемент е на индекс 0     осмият елемент е на индекс 7
