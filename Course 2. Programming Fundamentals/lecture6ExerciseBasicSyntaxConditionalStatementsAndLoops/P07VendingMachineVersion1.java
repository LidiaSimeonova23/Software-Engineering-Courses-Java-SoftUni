...
public class P07VendingMachineVersion1 {
        ...
        while (!input.equals("End")) {           //докато входните данни са различни от "End", ще четем име на продукт
            ...
            switch (input) {     //ще проверяваме входните данни, за да разберем кой е продуктът и каква е цената
                ...
                case "Coke":
                    unitPrice = 1.0;
                    break;
                default:             //във всички останали случаи (тоест, когато продуктът не е никой от изброените)
            ...
            boolean isValidProduct = input.equals("Nuts") || input.equals("Water") || input.equals("Crisps") || input.equals("Soda") || input.equals("Coke");

            if (isValidProduct) {        //ако продуктът е валиден
