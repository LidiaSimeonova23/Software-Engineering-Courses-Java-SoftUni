...
public class P04BallsVersion2 {
    public static void main(String[] args) {
        ...
        for (int currentBall = 1; currentBall <= numberOfBalls; currentBall++) {
            ...
            if (colourOfCurrentBall.equals("red")) {       //Ако топката е “red”, точките ни се повишават с 5.
            ...
            } else if (colourOfCurrentBall.equals("orange")) {    //Ако топката е “orange”, точките ни се повишават с 10.
                numberOfOrangeBalls++;
                points += 10;
            } else if (colourOfCurrentBall.equals("yellow")) {     //Ако топката е “yellow”, точките ни се повишават с 15.
                numberOfYellowBalls++;
                points += 15;
            } else if (colourOfCurrentBall.equals("white")) {      //Ако топката е “white”, точките ни се повишават с 20.
                numberOfWhiteBalls++;
                points += 20;
            } else if (colourOfCurrentBall.equals("black")) {      //Ако топката е “black”, точките ни се делят на 2, като закръгляме към по-малкото цяло число.
                numberOfBlackBalls++;
                points /= 2;         // points = points / 2;
                points = Math.floor(points);
            } else {          //Ако топката е с какъвто и да е цвят, различен от по-горните, точките не се манипулират и програмата продължава да работи.
                numberOfOtherBalls++;
            }
