...
public class P02DivisionVersion2 {
    public static void main(String[] args) {
        ...
        String divisor = "";     //създаваме си допълнителна променлива за делителя (не знаем кой е той в началото, затова задаваме като начална стойност дефолтната стойност на променливите от тип String, а именно празен String)
        ...
        //създаваме си допълнителна променлива, която ни държи условието за валидност на делителя
        boolean isValidDivisor = divisor.equals("10") || divisor.equals("7") || divisor.equals("6") || divisor.equals("3") || divisor.equals("2");
