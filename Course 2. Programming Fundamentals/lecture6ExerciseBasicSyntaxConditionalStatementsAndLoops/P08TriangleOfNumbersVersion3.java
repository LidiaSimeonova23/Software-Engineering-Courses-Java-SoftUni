...
public class P08TriangleOfNumbersVersion3 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        //Write a program that receives a number – n and prints a triangle from 1 to n as in the examples.
        //Constraints
        //•	n will be in the interval [1...20].   -> ако искаме да пестим памет, можем да определим числото n като променлива от тип byte (вместо int)

        byte n = Byte.parseByte(scanner.nextLine());       //от конзолата ще прочетем едно цяло число n, което ще е в диапазона от 1 до 20 включително
        ...
        for (byte currentRow = 1; currentRow <= n; currentRow++) {         // знаем, че броят на редовете ще е от 1 до прочетеното от конзолата число
            for (byte currentColumn = 1; currentColumn <= currentRow; currentColumn++) {        //за текущия ред колоните ще са толкова на брой, колкото е номерът на текущия ред
