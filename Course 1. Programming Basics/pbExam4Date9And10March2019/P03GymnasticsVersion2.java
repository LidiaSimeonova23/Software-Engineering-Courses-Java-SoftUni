...
public class P03GymnasticsVersion2 {
    public static void main(String[] args) {
        ...
        if (country.equals("Russia")) {              //ако държавата е Русия
        ...
        } else if (country.equals("Bulgaria")) {       //ако държавата е България
            if (device.equals("ribbon")) {             //ако уредът е лента
                difficultyAssessment = 9.600;
                performanceAssessment = 9.400;
            } else if (device.equals("hoop")) {        //ако уредът е обръч
        ...
        } else if (country.equals("Italy")) {        //ако държавата е Италия
            if (device.equals("ribbon")) {             //ако уредът е лента
