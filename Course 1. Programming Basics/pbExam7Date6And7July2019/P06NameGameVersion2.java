...
public class P06NameGameVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("Stop")) {
            ...
            if (totalPointsOfCurrentPlayer > maxPoints) {
            ...
            } else if (totalPointsOfCurrentPlayer == maxPoints) {    //В случай че двама играчи имат равен брой точки, печели този, който втори е достигнал резултата.  (ако точките на текущия играч са равни на точките на максималните точки за момента)
                maxPoints = totalPointsOfCurrentPlayer;
                winner = nameOfCurrentPlayer;
            }
