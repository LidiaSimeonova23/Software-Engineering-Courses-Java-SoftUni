...
public class P05ChristmasGiftsVersion2 {
    public static void main(String[] args) {
        ...
        int priceOfAllToys = counterKids * 5;     //намираме цената на всички играчки     //може променливата да е от тип int, защото единичната цена е цяла и е постоянна
        System.out.printf("Money for toys: %d%n", priceOfAllToys);

        int priceOfAllSweaters = counterAdults * 15;    //намираме цената на всички пуловери      //може променливата да е от тип int, защото единичната цена е цяла и е постоянна
        System.out.printf("Money for sweaters: %d", priceOfAllSweaters);
    }
}
