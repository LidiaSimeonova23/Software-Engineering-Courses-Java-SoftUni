...
public class P05TennisRanklistVersion2 {
    public static void main(String[] args) {
        ...
        for (int currentTournament = 1; currentTournament <= numberOfTournaments; currentTournament++) {
            ...
            if (stageAtCurrentTournament.equals("W")) {            //	W - ако е победител получава 2000 точки
                numberOfWins++;           //numberOfWins += 1;         //numberOfWins = numberOfWins + 1;      //броят на победите (спечелените турнири) се увеличава с единица
                currentPoints = 2000;
            } else if (stageAtCurrentTournament.equals("F")) {     //	F - ако е финалист получава 1200 точки
                currentPoints = 1200;
            } else if (stageAtCurrentTournament.equals("SF")) {    //	SF - ако е полуфиналист получава 720 точки
                currentPoints = 720;
            }
