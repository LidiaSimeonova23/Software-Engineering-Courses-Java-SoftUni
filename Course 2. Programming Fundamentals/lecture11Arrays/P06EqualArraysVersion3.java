...
public class P06EqualArraysVersion3 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        //ЗА ТОВА РЕШЕНИЕ НА ЗАДАЧАТА ПОЛЗВАМ МЕТОДИ (УЧАТ СЕ В ЛЕКЦИЯ 14) - всяко нещо, което ще се прави повече от веднъж, може да се изнесе/запише в отделен метод (един метод решава само един малък проблем)
        ...
        int[] firstArray = readAnIntegerArray(scanner);   //създаваме първия целочислен масив и му присвояваме като стойност метода readAnIntegerArray, който създадохме извън main метода
        int[] secondArray = readAnIntegerArray(scanner);   //създаваме втория целочислен масив и му присвояваме като стойност метода readAnIntegerArray, който създадохме извън main метода
    ...
    private static int[] readAnIntegerArray(Scanner scanner) {    //отделно от main метода, но в рамките на класа си създаваме отделен метод readAnIntegerArray, който чете от конзолата масив от цели числа
        return Arrays.stream(scanner.nextLine().split(" ")).mapToInt(Integer::parseInt).toArray();      //създаденият метод трябва да ни връща прочетения от конзолата целочислен масив
    }
