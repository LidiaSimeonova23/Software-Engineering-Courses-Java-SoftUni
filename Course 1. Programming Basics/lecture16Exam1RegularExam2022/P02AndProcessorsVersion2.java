...
public class P02AndProcessorsVersion2 {
    public static void main(String[] args) {
        ...
        double differenceBetweenNumbersOfProcessors = Math.abs(numberOfProcessorsToBeProduced - producedProcessors);    //намираме разликата между планирания брой процесори и броя на реално изработените процесори   - с абсолютна стойност си гарантираме, че разликата ще е положително число
        double differenceBetweenSums = differenceBetweenNumbersOfProcessors * 110.10;    //намираме разликата между сумите (тази разлика е или печалба, или загуба)
