...
public class P05TopIntegersVersion3 {
    public static void main(String[] args) {
        ...
        for (int index = 0; index <= numbersArray.length - 1; index++) {       // for (int index = 0; index < numbersArray.length; index++)     //на всяка итерация на цикъла взимаме текущ елемент от масива (от първия ... до последния)
            ...
            //ще трябва да сравняваме текущия елемент с всеки след него:
        ...
        System.out.println(numbersArray[numbersArray.length - 1]);     //накрая (извън външния for цикъл) винаги принтираме последния елемент от масива, тъй като той винаги е топ (вдясно от него няма други, с които да го сравним)
    }
}
