    ...
    public static void main(String[] args) {
        ...
        while (!input.equals("Finish")) {     //докато входните ни данни са различни от "Finish", ще четем входни данни (които ще са име на филм и брой свободни места за този филм)
            ...
            while (!typeOfTicket.equals("End")) {
                ...
                if (typeOfTicket.equals("student")) {                   //ако продаденият билет е от тип "student", броят на студентските билети нараства с единица
                    counterStudentTickets++;     //counterStudentTickets = counterStudentTickets + 1;
                } else if (typeOfTicket.equals("standard")) {           //ако продаденият билет е от тип "standard", броят на стандартните билети нараства с единица
                    counterStandardTickets++;    //counterStandardTickets = counterStandardTickets + 1;
                } else if (typeOfTicket.equals("kid")) {                //ако продаденият билет е от тип "kid", броят на детските билети нараства с единица
