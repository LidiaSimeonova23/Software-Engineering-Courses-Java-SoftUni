...
public class P02ExamPreparationVersion1 {
    public static void main(String[] args) {
        ...
        boolean needBreak = false;     //ще ни държи истината дали се нуждае от почивка (а той се нуждае, ако е достигнал определения брой слаби оценки)
        ...
        if (needBreak) {                   //Ако получи определения брой незадоволителни оценки
