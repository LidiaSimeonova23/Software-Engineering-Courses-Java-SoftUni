...
public class P01CompareMatricesVersion2 {
    public static void main(String[] args) {
        ...
        //в противен случай броят на редовете им съвпада и броят на колоните им съвпада, следователно има шанс двете матрици да са еднакви
