...
public class P01BackToThePastVersion2 {
    public static void main(String[] args) {
        ...
        int years = 17;
        double spentMoneyPerEvenYears = 0;
        double spentMoneyPerOddYears = 0;
        ...
        for (int currentYear = 1800; currentYear <= yearToLive; currentYear++) {         //като име на променливата ползвам currentYear вместо  i
            ...
            if (currentYear % 2 == 0) {
                ...
                spentMoneyPerEvenYears = spentMoneyPerEvenYears + spentMoneyPerYear;
                ...
                spentMoneyPerOddYears = spentMoneyPerOddYears + spentMoneyPerYear;
            }

            totalSpentMoneyForAllYears = spentMoneyPerEvenYears + spentMoneyPerOddYears;
        }


        if (inheritedMoney >= totalSpentMoneyForAllYears) {
            System.out.printf("Yes! He will live a carefree life and will have %.2f dollars left.", inheritedMoney - totalSpentMoneyForAllYears);
        } else {       //else if (inheritedMoney < totalSpentMoneyForAllYears)
            System.out.printf("He will need %.2f dollars to survive.", totalSpentMoneyForAllYears - inheritedMoney);
        }
