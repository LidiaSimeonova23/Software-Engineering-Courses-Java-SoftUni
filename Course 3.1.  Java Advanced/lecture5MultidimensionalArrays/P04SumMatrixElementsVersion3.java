...
public class P04SumMatrixElementsVersion3 {
    public static void main(String[] args) {
        ...
        //2. намираме сумата от всички елементи на матрицата - в случая може и с 2 вложени foreach цикъла, защото не ни трябват индексите на елементите
        for (int[] row : dataMatrix) {
            for (int cell : row) {
                sumMatrixElements += cell;      //sumMatrixElements = sumMatrixElements + cell;
            }
