...
public class P05ClubVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("Party!")) {
            ...
            double priceOfCurrentCocktail = input.length();          //намираме цената на коктейла   (цената на един коктейл е дължината на неговото име)
        ...
        if (input.equals("Party!")) {
            System.out.printf("We need %.2f leva more.%n", wantedProfit - totalSumOfAllTypesOfCocktails);
