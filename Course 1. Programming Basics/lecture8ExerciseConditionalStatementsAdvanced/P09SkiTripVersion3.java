...
public class P09SkiTripVersion3 {
    public static void main(String[] args) {
        ...
        switch (roomType) {
            case "room for one person":                                            //ако  видът помещение е единична стая, няма никаква отстъпка
                holidayPrice = nights * 18.00;                                              //цената на ваканцията =  брой нощувки по цена за една нощувка
                break;
            case "apartment":                                                      //ако  видът помещение е апартамент
                ...
                break;
            case "president apartment":                                            //ако  видът помещение е президентски апартамент
