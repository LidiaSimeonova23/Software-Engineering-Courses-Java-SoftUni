...
public class P06FlowerShopVersion2 {
    public static void main(String[] args) {
        ...
        if (availableMoney >= presentPrice) {
            double remainingMoney = Math.floor(availableMoney - presentPrice);
            System.out.printf("She is left with %.0f leva.", remainingMoney);
        } else {
            double missingMoney = Math.ceil(presentPrice - availableMoney);
            System.out.printf("She will have to borrow %.0f leva.", missingMoney);
        }
