...
public class P06BasketballTournamentVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("End of tournaments")) {
            ...
            for (int currentGame = 1; currentGame <= numberOfGamesOfCurrentTournament; currentGame++) {
                ...
                if (numberOfPointsOfTeamOfDesi > numberOfPointsOfOpposingTeam) {         //Ако отборът на Деси е спечелил
                    ...
                    System.out.printf("Game %d of tournament %s: win with %d points.%n", currentGame, nameOfCurrentTournament, numberOfPointsOfTeamOfDesi - numberOfPointsOfOpposingTeam);
                    ...
                    System.out.printf("Game %d of tournament %s: lost with %d points.%n", currentGame, nameOfCurrentTournament, numberOfPointsOfOpposingTeam - numberOfPointsOfTeamOfDesi);
                }
        ...
        double percentageOfLostGamesFromAllTournaments = 100 - percentageOfWonGamesFromAllTournaments;
