...
public class P01TrainVersion4 {
    public static void main(String[] args) {
        ...
        for (int currentWagon = 1; currentWagon <= numberOfWagons; currentWagon++) {    //вместо променливата currentWagon можехме да ползваме i
            int numberOfPeopleInTheCurrentWagon = Integer.parseInt(scanner.nextLine());       //на всяка итерация на цикъла четем брой хора в текущия вагон на влака
