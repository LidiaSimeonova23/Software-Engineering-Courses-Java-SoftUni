...
public class P05MaximumSumOf2x2SubmatrixVersion2 {
    public static void main(String[] args) {
        ...
        //извикваме си метода, който създадохме - за четене на стойности за елементите на матрицата (присвояваме им стойности, които четем от конзолата)
        settingValuesOfMatrixElements(dataMatrix, scanner);
        ...
        for (int row = 0; row < dataMatrix.length - 1; row++) {       //тъй като ще взимаме редовете два по два (текущия и следващия), трябва да спрем цикъла не на последния ред, а на предпоследния (защото когато вземем предпоследния, с него ще върви и последният)
            for (int column = 0; column < dataMatrix[row].length - 1; column++) {         //тъй като ще взимаме колоните две по две (текущата и следващата), трябва да спрем цикъла не на последната колона, а на предпоследната (защото когато вземем предпоследната, с нея ще върви и последната)
    ...
    private static void settingValuesOfMatrixElements(int[][] dataMatrix, Scanner scanner) {       //създаваме си метод за четене на стойности за елементите на матрицата (присвояваме им стойности, които четем от конзолата)
