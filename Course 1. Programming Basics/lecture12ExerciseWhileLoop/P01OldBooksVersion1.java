...
public class P01OldBooksVersion1 {
    public static void main(String[] args) {
        ...
        boolean isFound = false;   //създаваме си boolean променлива, която ни държи истината (условието)
        ...
        if (isFound) {                                     //ако търсената книга е намерена
