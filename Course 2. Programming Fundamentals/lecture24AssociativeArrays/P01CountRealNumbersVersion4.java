...
public class P01CountRealNumbersVersion4 {
    public static void main(String[] args) {
        ...
        for (int number : numbersArray) {      //за всеки елемент от масив numbersArray
            //към асоц. масив countMap да се прибави ключът (прочетеното число, тоест текущия елемент от масива), ако липсва ->
            countMap.putIfAbsent(number, 0);               //това число да се добави към асоц. масив (числото да е ключ, стойността да е 0)
