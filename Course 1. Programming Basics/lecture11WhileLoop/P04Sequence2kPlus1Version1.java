...
public class P04Sequence2kPlus1Version1 {
    public static void main(String[] args) {
        ...
        while (true) {                   //докато условието е вярно, влизай в тялото на цикъла и изпълнявай кода - тоест, принтирай текущото число

            if (currentNumber > number) {       //ако текущото число стане > от първоначално въведеното число, цикълът да се прекъсне - условие за прекъсване на цикъла
                break;
            }
