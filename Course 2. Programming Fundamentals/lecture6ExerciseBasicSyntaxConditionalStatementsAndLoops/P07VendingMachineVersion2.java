...
public class P07VendingMachineVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("End")) {           //докато входните данни са различни от "End", ще четем име на продукт
            ...
            //след като сме напуснали проверката, компилаторът е забравил кой продукт е валиден и кой не е валиден, затова си създаваме булева променлива за валидност на продукта, която ще ползваме в следващата проверка
            boolean isValidProduct = currentProduct.equals("Nuts") || currentProduct.equals("Water") || currentProduct.equals("Crisps") || currentProduct.equals("Soda") || currentProduct.equals("Coke");

            if (isValidProduct && sumOfInsertedCoins >= unitPrice) {        //ако продуктът е валиден и ако можем да си го купим (тоест, ако сумата, която имаме, е поне толкова, колкото струва продуктът), си го купуваме
            ...
            } else if (isValidProduct && sumOfInsertedCoins < unitPrice) {       //или ако продуктът е валиден, но не можем да си го купим (защото няма достатъчно пари в машината)
