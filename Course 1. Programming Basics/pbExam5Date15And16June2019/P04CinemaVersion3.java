...
public class P04CinemaVersion3 {
    public static void main(String[] args) {
        ...
        //проверка кое от двете условия за прекъсване на цикъла се е случило (и съответните принтирания):
        if (input.equals("Movie time!")) {      //ако входните данни са били "Movie time!"
        ...
        } else {      //в противен случай (тоест, когато в залата се опитат да влязат повече хора, отколкото места са останали)
