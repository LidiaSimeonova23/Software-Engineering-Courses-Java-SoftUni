...
public class P05ConcatNamesVersion1 {
    public static void main(String[] args) {
        ...
        System.out.printf("%s%s%s", name1, delimiter, name2);   //принтираме първото и второто име, като между тях е делимитерът (специалният символ)  - всички те са залепени един за друг (без разстояние между тях)
    }
}
