...
public class P05GameOfIntervalsVersion2 {
    public static void main(String[] args) {
        ...
        for (int step = 1; step <= numberOfSteps; step++) {          //за да си построя цикъла, съм използвала за име на променливата step вместо i
            ...
            if (currentNumberCarryingPoints < 0 || currentNumberCarryingPoints > 50) {      //ако текущото число е невалидно, делим резултата на 2 (и резултатът намалява)
                result = result / 2;
            } else {            //във всички останали случаи (тоест, ако текущото число е валидно), към резултата прибавяме точките и резултатът се увеличава
