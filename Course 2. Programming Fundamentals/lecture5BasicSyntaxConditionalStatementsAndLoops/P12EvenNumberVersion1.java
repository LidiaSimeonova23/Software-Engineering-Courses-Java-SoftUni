...
public class P12EvenNumberVersion1 {
    public static void main(String[] args) {
        ...
        System.out.printf("The number is: %d", Math.abs(number));   //щом горното условие е станало false, значи вече числото е четно - да се принтира абсолютната му стойност - това принтиране е извън цикъла - ще е само веднъж и ще прекрати програмата
    }
}
