...
public class P01StudentInformationVersion3 {
    public static void main(String[] args) {
        ...
        System.out.printf("Name: %s, Age: %s, Grade: %s", name, age, averageGrade);   //форматирах оценката до 2 знака след десетичната точка - с %.2f
    }
}
