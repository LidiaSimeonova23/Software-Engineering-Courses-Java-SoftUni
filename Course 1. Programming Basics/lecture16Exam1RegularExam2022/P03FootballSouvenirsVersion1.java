...
public class P03FootballSouvenirsVersion1 {
    public static void main(String[] args) {
        ...
        switch (nameOfTeam) {
            case "Argentina":             //ако отборът е Аржентина
                ...
                break;
            case "Brazil":          //или ако отборът е Бразилия
                if (typeOfSouvenir.equals("flags")) {
                    unitPrice = 4.20;
                } else if (typeOfSouvenir.equals("caps")) {
                    unitPrice = 8.50;
                ...
                break;
            case "Croatia":       //или ако отборът е Хърватия
                if (typeOfSouvenir.equals("flags")) {
                    unitPrice = 2.75;
                } else if (typeOfSouvenir.equals("caps")) {
                    unitPrice = 6.90;
                ...
                break;
            case "Denmark":         //или ако отборът е Дания
                if (typeOfSouvenir.equals("flags")) {
                    unitPrice = 3.10;
                } else if (typeOfSouvenir.equals("caps")) {
                    unitPrice = 6.50;
                ...
                break;
            default:                //във всички останали случаи (тоест, ако отборът не е никой от вече изброените)
