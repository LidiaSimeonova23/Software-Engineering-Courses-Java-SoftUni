...
public class P03TravelAgencyVersion1 {
    public static void main(String[] args) {
        ...
        if (!isValidTown || !isValidTypeOfService) {      //ако градът е невалиден или ако видът на услугата е невалиден
            System.out.println("Invalid input!");
        } else if (numberOfDays < 1) {       //Ако потребителят е въвел по-малко от 1 ден за престой
            System.out.println("Days must be positive number!");
        } else {       //Когато потребителят е въвел всички данни правилно
