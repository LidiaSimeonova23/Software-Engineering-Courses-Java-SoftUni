...
public class P06CakeVersion2 {
    public static void main(String[] args) {
        ...
        while (!input.equals("STOP")) {                  //докато входните данни са различни от Stop, цикълът да се върти
            ...
            cakePieces = cakePieces - currentPieces;              //парчетата торта, които остовот, са равни на парчетата до момента минус парчетата, които са взети
        ...
        if (cakePieces <= 0) {                    //ако парчетата са свършили, да се принтира колко не са достигнали
