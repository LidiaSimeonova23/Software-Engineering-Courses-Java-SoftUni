...
public class P04CleverLilyVersion1 {
    public static void main(String[] args) {
        ...
        double differenceInMoney = Math.abs(totalMoney - priceOfWashingMachine);
        if (totalMoney >= priceOfWashingMachine) {                   //ако е събрала достатъчно пари (тоест повече или колкото е пералнята), да се принтира колко са й останали
            System.out.printf("Yes! %.2f", differenceInMoney);
            ...
            System.out.printf("No! %.2f", differenceInMoney);        //вместо Math.abs(totalMoney - priceOfWashingMachine)   можем да напишем:     priceOfWashingMachine - totalMoney
        }
